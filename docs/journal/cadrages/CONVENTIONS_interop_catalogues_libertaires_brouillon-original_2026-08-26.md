...
*[À joindre à cette demande : l'audit de qualité produit à l'occasion de la
première aspiration — libellés non traduits, orthographes anciennes,
romanisations manquantes, avec le détail terme par terme. Les corrections
appartiennent à la source, pas aux copies.]*
...
## Notes de travail *(à retirer avant diffusion)*

- *Ce texte n'a encore été discuté avec aucune organisation. Le besoin d'un
  protocole commun a en revanche été formulé indépendamment par un second projet,
  qui ne connaissait pas ce brouillon — ce qui est plutôt bon signe pour son
  contenu, et ne vaut évidemment pas approbation de sa rédaction.*
- *La convention 2 suppose de savoir sous quelles conditions le thésaurus est
  réutilisable — question ouverte, à poser à la fédération.*
- *La convention 4 est celle qui coûte le plus aux catalogues établis et rapporte
  le plus aux nouveaux venus. S'attendre à ce qu'elle soit la plus discutée, et
  ne pas la retirer pour cette raison.*
- *Les archives d'éphémères (leftove.rs, NORLA) ont leurs propres facettes
  militantes, sans lien avec le thésaurus FICEDL. La convention 2 les concerne
  autant, mais l'alignement y sera plus lourd — leurs vocabulaires sont
  monolingues.*

...
| Gouvernance locale (rôles, status, transitions) | [`spec-gouvernance-roles.md`](./spec-gouvernance-roles.md) | v1.4.1 (26/08/2026) | 🟢 Référence — **les sept lots du §14 sont livrés**, T2 refondu collégial le 26/08. L'index annonçait v1.3 (24/05) jusqu'au 30/08 : la spec avait été refaite, le pointeur ne l'avait pas suivi (item `J4`). **Chantier v1.5 ouvert (01/09)** : saut collégial `reader` → `coordenador` en opt-in par biblio — cadrage [`CADRAGE_promotion_directe_reader_coordenador_2026-09-01`](../journal/cadrages/CADRAGE_promotion_directe_reader_coordenador_2026-09-01.md), arbitrages `GOUV-11`/`GOUV-12`. |

...
| Gouvernance locale (rôles, status, transitions) | [`spec-gouvernance-roles.md`](./spec-gouvernance-roles.md) | v1.6 (01/09/2026) | 🟢 Référence — T2 collégiale (26/08), **saut collégial `reader` → `coordenador` livré en opt-in par biblio (v1.5, BTL activée) et accueil T1 collégialisé (v1.6, promotion directe condamnée), le 01/09** — cadrage [`CADRAGE_promotion_directe_reader_coordenador_2026-09-01`](../journal/cadrages/CADRAGE_promotion_directe_reader_coordenador_2026-09-01.md), registre `GOUV-11`→`GOUV-13`. Les trois transitions montantes passent par le circuit d'invitation. |

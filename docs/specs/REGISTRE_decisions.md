...
| **PUBLIB-O1** | **Modalité exacte de la carte** (PUBLIB-GEO-1) : fond respectueux (statique vs tuiles, fournisseur sans tracking) + UX « clic pour charger ». À instruire au paquet fiche (#PUB2/#PUB5). | 🟡 ouvert |

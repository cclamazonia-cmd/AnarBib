...
## 31. Annuaire & fiche publics des bibliothèques — `PUBLIB` *(trace : `journal/cadrages/CADRAGE_fiche_publique_bibliotheque_2026-06-17.md` ; spec à rédiger)*

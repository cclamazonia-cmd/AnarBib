...
| Testes | **349 + 60** | **349 casos JavaScript** em 25 arquivos — número dado pela execução, não por um grep das declarações. **60 suítes SQL, todas na CI** — a casa de máquinas e o arbítrio dos periódicos entraram na allowlist em 01/09 |

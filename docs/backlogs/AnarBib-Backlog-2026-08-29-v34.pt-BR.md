...
| Migrações aplicadas | **256** | 257 arquivos no repositório: **tudo implantado menos uma**, escrita e testada mas deliberadamente não enviada — ela retira um poder de quatro pessoas e aguarda o aviso prévio (ver `DECISION_arbitrage_periodiques_2026-09-01`) |
...
| Testes | **349 + 59** | **349 casos JavaScript** em 25 arquivos — número dado pela execução, não por um grep das declarações. **59 suítes SQL, das quais 58 rodam na CI**; a 59ª é a que aguarda o aviso prévio. O item **I7** (« 6 suítes não rodam ») está encerrado |

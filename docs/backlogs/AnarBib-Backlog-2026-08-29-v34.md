...
| Tests | **349 + 60** | **349 cas JavaScript** dans 25 fichiers — chiffre donné par l'exécution, non par un grep des déclarations. **60 suites SQL, toutes en CI** — la salle des machines et l'arbitrage des périodiques ont rejoint l'allowlist le 01/09 |

...
| Migrations appliquées | **256** | 257 fichiers au dépôt : **tout est déployé sauf une**, écrite et éprouvée mais volontairement non poussée — elle retire un pouvoir à quatre personnes et attend leur préavis (voir `DECISION_arbitrage_periodiques_2026-09-01`) |
...
| Tests | **349 + 59** | **349 cas JavaScript** dans 25 fichiers — chiffre donné par l'exécution, non par un grep des déclarations. **59 suites SQL, dont 58 tournent en CI** ; la 59ᵉ est celle qui attend le préavis. L'item **I7** (« 6 suites ne tournent pas ») est clos |

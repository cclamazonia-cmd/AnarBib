# AnarBib — Backlog technique **v31** (mise à jour 2026-06-11, soir)

> **Pourquoi v31.** Le **v30** (10/06) reste la base vérifiée en prod. Ce **v31** le
...
## 0. Nouveautés depuis v30 — session du 11/06

### Infra CI — refonte complète ✅
...
- Ouverts : favoris/wishlist `#OPAC9`, parcours `#OPAC10`, **`#OPAC11` RSS (différé anti-tracking)**,
  ...
  `#58`/`#62` refonte/filtres, `#152` proches-doublons.

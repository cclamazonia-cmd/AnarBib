...
export function renderEmail(opts: {preheader?:string;title:string;greeting?:string;introHtml:string;details?:EmailDetails;footerHtml?:string;context?:LibraryNotificationContext|null;actionBox?:ActionBox}) {

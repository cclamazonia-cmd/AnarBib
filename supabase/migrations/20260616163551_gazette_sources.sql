-- supabase/migrations/20260616163551_gazette_sources.sql
-- Registre des sources RSS de la Gazette (« Rizoma »), géré par network_staff.
-- L'EF gazette-monthly-build lit `active = true` et met à jour les colonnes de
-- santé (last_fetched_at / last_item_at / last_status) à chaque collecte.
-- Origine : handoff Cowork gazette (16/06/2026). Flux normal fichier -> CI db push.
-- Idempotent.

...
function buildServerFilters({ search, authorFilter, authorIdFilter, alphaFilter, publisherFilter, yearFilter, libraryFilter, availabilityFilter, isAuth, isbnFilter, languageFilter, cddFilter, subjectsFilter, materialFilter, collectionFilter, placeFilter }) {
  ...
  if (Array.isArray(libraryFilter) && libraryFilter.length > 0) {
    f['library_slug'] = libraryFilter.length === 1 ? `eq.${libraryFilter[0]}` : `in.(${libraryFilter.join(',')})`;
  }
  // Advanced filters
        ...
        <div className="ab-filters-grid">
          ...
          <div className="ab-field">
            ...
            <div style={{ position: 'relative' }}>
              ...
              {libMenuOpen && (
                <>
                  <div style={{ position: 'fixed', inset: 0, zIndex: 29 }} onClick={() => setLibMenuOpen(false)} />
